...
if __name__ == "__main__":
    ...
    segmented_dir = '/workspace/RibCage/test-segmented_ribfrac'  
    defected_dir = '/workspace/RibCage/test-ribfrac-defected'  
    implant_dir = '/workspace/RibCage/test-ribfrac-implants'  
    cube_dim = 64 
